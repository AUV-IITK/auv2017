...
void callback(task_torpedo::torpedoConfig &config, uint32_t level)
{
  ...
  ROS_INFO("Torpedo_Reconfigure Request:New params: %d %d %d %d %d %d ", t1min, t1max, t2min, t2max, t3min, t3max);
}
...
int main(int argc, char *argv[])
{
  ...
  n.getParam("cupid_detection/t1max", t1max);
  n.getParam("cupid_detection/t1min", t1min);
  n.getParam("cupid_detection/t2max", t2max);
  n.getParam("cupid_detection/t2min", t2min);
  n.getParam("cupid_detection/t3max", t3max);
  n.getParam("cupid_detection/t3min", t3min);
