...
int main(int argc, char* argv[])
{
  ...
  n.subscribe<std_msgs::Bool>("balls_off", 1000, &lineDetectedListener);
  ...
  Mat  hsv_frame,thresholded,thresholded1,thresholded2,thresholded3,filtered;  // image converted to HSV plane
