...
int main(int argc, char *argv[])
{
  ...
  n.getParam("circle_detection/t1maxParam", t1max);
  n.getParam("circle_detection/t1minParam", t1min);
  n.getParam("circle_detection/t2maxParam", t2max);
  n.getParam("circle_detection/t2minParam", t2min);
  n.getParam("circle_detection/t3maxParam", t3max);
  n.getParam("circle_detection/t3minParam", t3min);
